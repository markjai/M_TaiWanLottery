"""今彩539 (Daily Cash 5/39) API endpoints."""
...
from taiwan_lottery.schemas.lottery import DailyCashDrawSchema, PaginatedResponse

router = APIRouter()


@router.get("/latest", response_model=DailyCashDrawSchema)
...
async def get_draws(
    ...
    return PaginatedResponse(
        items=[DailyCashDrawSchema.model_validate(d) for d in draws],
        total=total,
        page=page,
        page_size=page_size,
...
@router.get("/draws/{term}", response_model=DailyCashDrawSchema)

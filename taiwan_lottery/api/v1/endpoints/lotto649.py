...
from taiwan_lottery.schemas.lottery import Lotto649DrawSchema, PaginatedResponse

router = APIRouter()


@router.get("/latest", response_model=Lotto649DrawSchema)
...
async def get_draws(
    ...
    return PaginatedResponse(
        items=[Lotto649DrawSchema.model_validate(d) for d in draws],
        total=total,
        page=page,
        page_size=page_size,
...
@router.get("/draws/{term}", response_model=Lotto649DrawSchema)

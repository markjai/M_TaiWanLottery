...
from taiwan_lottery.schemas.lottery import SuperLottoDrawSchema, PaginatedResponse

router = APIRouter()


@router.get("/latest", response_model=SuperLottoDrawSchema)
...
async def get_draws(
    ...
    return PaginatedResponse(
        items=[SuperLottoDrawSchema.model_validate(d) for d in draws],
        total=total,
        page=page,
        page_size=page_size,
...
@router.get("/draws/{term}", response_model=SuperLottoDrawSchema)
